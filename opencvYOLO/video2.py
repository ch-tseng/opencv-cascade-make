...
modelConfiguration = "cfg.loofah/yolov3-tiny.cfg";
modelWeights = "cfg.loofah/yolov3-tiny_10000.weights";
...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    cv.putText(frame, label, (left, top), cv.FONT_HERSHEY_SIMPLEX, 5, (255,255,255))
...
while cv.waitKey(1) < 0:
    ...
    cv.putText(frame, label, (0, 15), cv.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 255))
